...
<div class="content">
	<div class="col grid_12">
		<div class="col grid_8">
			<div class="box">
				<div style="    background: url(/web/img/bg_textureout.png),#d61010;" id="title">
					<i style="    background: url(/web/img/bg_textureout.png),#9c0909;"class="fa fa-cogs"></i>
					<span>MİMARLAR</span>
				</div>
																							<?php
...
?>																						
			...
			<div class="box">
				<div style="    background: url(/web/img/bg_textureout.png),#d61010;"id="title">
					<i style="    background: url(/web/img/bg_textureout.png),#9c0909;"class="fa fa-code"></i>
					<span>VİP</span>
				</div>
																							<?php
