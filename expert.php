...
<div class="box">
<div class="staffboxtext">- Büyük Elçi -</div>
<hr>
<?php
...
<hr class="hr-staff">
<div class="staffstats">Görev: <?php echo $sql['staffstatus']; ?></div>
<br><div class="staffstats">Mimarlik Seviyesi: 0<?php echo $meinlevel ?></div>
<br><div class="staffstats">Motto: <?php echo $sql['motto']; ?></div>
</div>
<?php } ?>
</div>
...
<br><div class="staffstats">Kanalım: Buraya tıkla</div></br>
